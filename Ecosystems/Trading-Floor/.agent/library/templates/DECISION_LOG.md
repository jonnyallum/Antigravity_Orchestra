...
## 🚩 Problem Statement
[Describe the core issue, conflict, or architectural challenge being addressed.]

## 💡 Context
- **Current State**: [Describe the existing implementation.]
- **Drivers**: [Why is this a priority now? Business value? Technical debt?]
